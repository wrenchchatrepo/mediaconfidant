# The name of this view in Looker is "P Ads Age Range Basic Stats 1962270511"
view: p_ads_age_range_basic_stats_1962270511 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `google_ads.p_ads_AgeRangeBasicStats_1962270511` ;;
