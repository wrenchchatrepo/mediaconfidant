# The name of this view in Looker is "Ads Parental Status Basic Stats 1962270511"
view: ads_parental_status_basic_stats_1962270511 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `google_ads.ads_ParentalStatusBasicStats_1962270511` ;;
