# The name of this view in Looker is "P Ads Gender 1962270511"
view: p_ads_gender_1962270511 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `google_ads.p_ads_Gender_1962270511` ;;
  ...
  dimension: ad_group_criterion_gender_type {
    type: string
    description: "Type of the gender."
    sql: ${TABLE}.ad_group_criterion_gender_type ;;
  }
