# The name of this view in Looker is "P Ads Placement 1962270511"
view: p_ads_placement_1962270511 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `google_ads.p_ads_Placement_1962270511` ;;
  ...
  dimension: ad_group_criterion_placement_url {
    type: string
    description: "URL of the placement. For example, \\\"http://www.domain.com\\\"."
    sql: ${TABLE}.ad_group_criterion_placement_url ;;
  }
