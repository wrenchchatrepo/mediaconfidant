# The name of this view in Looker is "P Ads Video Conversion Stats 1962270511"
view: p_ads_video_conversion_stats_1962270511 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `google_ads.p_ads_VideoConversionStats_1962270511` ;;
  ...
  measure: total_metrics_conversions {
    type: sum
    sql: ${metrics_conversions} ;;  }
  measure: average_metrics_conversions {
    type: average
    sql: ${metrics_conversions} ;;  }
