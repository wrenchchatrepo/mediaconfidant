# The name of this view in Looker is "P Ads Ad Group Ad Label 1962270511"
view: p_ads_ad_group_ad_label_1962270511 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `google_ads.p_ads_AdGroupAdLabel_1962270511` ;;
  ...
  dimension: ad_group_ad_label_ad_group_ad {
    type: string
    description: "The ad group ad to which the label is attached."
    sql: ${TABLE}.ad_group_ad_label_ad_group_ad ;;
  }

  dimension: ad_group_ad_label_label {
    type: string
    description: "The label assigned to the ad group ad."
    sql: ${TABLE}.ad_group_ad_label_label ;;
  }

  dimension: ad_group_ad_label_resource_name {
    type: string
    description: "The resource name of the ad group ad label. Ad group ad label resource names have the form: `customers/{customer_id}/adGroupAdLabels/{ad_group_id}~{ad_id}~{label_id}`"
