# The name of this view in Looker is "Ads Account Conversion Stats 1962270511"
view: ads_account_conversion_stats_1962270511 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `google_ads.ads_AccountConversionStats_1962270511` ;;
