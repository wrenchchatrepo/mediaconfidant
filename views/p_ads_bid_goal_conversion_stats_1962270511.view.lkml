# The name of this view in Looker is "P Ads Bid Goal Conversion Stats 1962270511"
view: p_ads_bid_goal_conversion_stats_1962270511 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `google_ads.p_ads_BidGoalConversionStats_1962270511` ;;
  ...
  dimension: bidding_strategy_campaign_count {
    type: number
    description: "The number of campaigns attached to this bidding strategy. This field is read-only."
  ...
  dimension: bidding_strategy_non_removed_campaign_count {
    type: number
    description: "The number of non-removed campaigns attached to this bidding strategy. This field is read-only."
