# The name of this view in Looker is "Ads Locations User Locations Stats 1962270511"
view: ads_locations_user_locations_stats_1962270511 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `google_ads.ads_LocationsUserLocationsStats_1962270511` ;;
