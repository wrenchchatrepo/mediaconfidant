# The name of this view in Looker is "P Ads Budget Stats 1962270511"
view: p_ads_budget_stats_1962270511 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `google_ads.p_ads_BudgetStats_1962270511` ;;
  ...
  dimension_group: _partitiontime {
    ...
    # This dimension will be called "Campaign Budget ID" in Explore.
  ...
  dimension: campaign_budget_recommended_budget_estimated_change_weekly_clicks {
    type: number
    description: "The estimated change in weekly clicks if the recommended budget is applied. This field is read-only."
    sql: ${TABLE}.campaign_budget_recommended_budget_estimated_change_weekly_clicks ;;
  }

  dimension: campaign_budget_recommended_budget_estimated_change_weekly_cost_micros {
    type: number
    description: "The estimated change in weekly cost in micros if the recommended budget is applied. One million is equivalent to one currency unit. This field is read-only."
    sql: ${TABLE}.campaign_budget_recommended_budget_estimated_change_weekly_cost_micros ;;
  }
  ...
  measure: total_campaign_budget_recommended_budget_estimated_change_weekly_cost_micros {
    type: sum
    sql: ${campaign_budget_recommended_budget_estimated_change_weekly_cost_micros} ;;  }
  measure: average_campaign_budget_recommended_budget_estimated_change_weekly_cost_micros {
    type: average
    sql: ${campaign_budget_recommended_budget_estimated_change_weekly_cost_micros} ;;  }

  dimension: campaign_budget_recommended_budget_estimated_change_weekly_interactions {
    type: number
    description: "The estimated change in weekly interactions if the recommended budget is applied. This field is read-only."
    sql: ${TABLE}.campaign_budget_recommended_budget_estimated_change_weekly_interactions ;;
  }

  dimension: campaign_budget_recommended_budget_estimated_change_weekly_views {
    type: number
    description: "The estimated change in weekly views if the recommended budget is applied. This field is read-only."
    sql: ${TABLE}.campaign_budget_recommended_budget_estimated_change_weekly_views ;;
  }
