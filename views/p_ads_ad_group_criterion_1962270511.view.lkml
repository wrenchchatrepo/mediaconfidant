# The name of this view in Looker is "P Ads Ad Group Criterion 1962270511"
view: p_ads_ad_group_criterion_1962270511 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `google_ads.p_ads_AdGroupCriterion_1962270511` ;;
  ...
  dimension: ad_group_criterion_cpv_bid_micros {
    type: number
    description: "The CPC (cost-per-view) bid."
