# The name of this view in Looker is "P Ads Parental Status Non Click Stats 1962270511"
view: p_ads_parental_status_non_click_stats_1962270511 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `google_ads.p_ads_ParentalStatusNonClickStats_1962270511` ;;
