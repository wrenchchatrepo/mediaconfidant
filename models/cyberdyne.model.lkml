...
test: event_timestamp_no_nulls {
  explore_source: cyberdyne_ga4 {
    column: event_timestamp {}
  }
  assert: event_timestamp_is_not_null {
...
test: valid_conversions_range {
  explore_source: cyberdyne_google {
    column: conversions {}
  }
  assert: conversions_are_valid {
    expression: ${conversions} BETWEEN 0 AND 10000 ;;
  }
}

test: valid_clicks_range {
  explore_source: cyberdyne_facebook {
    column: clicks {}
  }
  assert: clicks_are_valid {
    expression: ${clicks} BETWEEN 0 AND 1000000 ;;
  }
}

test: valid_cost_range {
  explore_source: cyberdyne_tiktok {
    column: cost {}
  }
  assert: cost_is_valid {
    expression: ${cost} BETWEEN 0 AND 500000 ;;
  }
}
